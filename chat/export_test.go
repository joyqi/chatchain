...
func exportTestHistory() []provider.Message {
	return []provider.Message{
		...
		{Role: "assistant", Reasoning: "let me think about this",
			ToolCalls: []provider.ToolCall{{ID: "c1", Name: "read_file", Arguments: map[string]any{"path": "a.txt"}}}},
		{Role: "tool", Content: "file contents", ToolCallID: "c1", ToolCallName: "read_file"},
