...
//
// Vendored from github.com/manifoldco/promptui v0.9.0 (BSD 3-Clause, see LICENSE.md)
// and kept in-tree so ChatChain can extend it with additional interaction types.
//
